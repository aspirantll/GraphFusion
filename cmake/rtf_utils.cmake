###############################################################################
# this file is modified from pcl_utils.cmake
###############################################################################
...
macro(DISSECT_VERSION)
    ...
    if(GraphFusion_VERSION_TWEAK EQUAL 99)
        set(GraphFusion_DEV_VERSION 1)
        set(GraphFusion_VERSION_PRETTY "${GraphFusion_VERSION_MAJOR}.${GraphFusion_VERSION_MINOR}.${GraphFusion_VERSION_PATCH}-dev")
    else()
        set(GraphFusion_DEV_VERSION 0)
        set(GraphFusion_VERSION_PRETTY "${GraphFusion_VERSION_MAJOR}.${GraphFusion_VERSION_MINOR}.${GraphFusion_VERSION_PATCH}")
    endif()
endmacro()
  ...
  if(NOT DEFINED LIB_INSTALL_DIR)
    ...
    if(NOT ANDROID)
      set(INCLUDE_INSTALL_ROOT
          "include/${PROJECT_NAME_LOWER}-${GraphFusion_VERSION_MAJOR}.${GraphFusion_VERSION_MINOR}")
    else()
      set(INCLUDE_INSTALL_ROOT "include") # Android, don't put into subdir
    endif()
    set(INCLUDE_INSTALL_DIR "${INCLUDE_INSTALL_ROOT}/rtf")
    set(DOC_INSTALL_DIR "share/doc/${PROJECT_NAME_LOWER}-${GraphFusion_VERSION_MAJOR}.${GraphFusion_VERSION_MINOR}")
    set(BIN_INSTALL_DIR "bin")
    set(PKGCFG_INSTALL_DIR "${LIB_INSTALL_DIR}/pkgconfig")
    if(WIN32 AND NOT MINGW)
        set(GraphFusionCONFIG_INSTALL_DIR "cmake")
      else()
        set(GraphFusionCONFIG_INSTALL_DIR "share/${PROJECT_NAME_LOWER}-${GraphFusion_VERSION_MAJOR}.${GraphFusion_VERSION_MINOR}")
      endif()
endmacro()
...
function(find_python_module module)
  ...
  if(NOT PY_${module_upper})
    ...
    # A core's location is usually a directory, but for binary modules
    # it's a .so file.
