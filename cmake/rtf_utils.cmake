...
macro(DISSECT_VERSION)
    ...
    if(RTF_VERSION_TWEAK EQUAL 99)
        set(RTF_DEV_VERSION 1)
        set(RTF_VERSION_PRETTY "${RTF_VERSION_MAJOR}.${RTF_VERSION_MINOR}.${RTF_VERSION_PATCH}-dev")
    else()
        set(RTF_DEV_VERSION 0)
        set(RTF_VERSION_PRETTY "${RTF_VERSION_MAJOR}.${RTF_VERSION_MINOR}.${RTF_VERSION_PATCH}")
    endif()
endmacro()
  ...
  if(NOT DEFINED LIB_INSTALL_DIR)
    ...
    if(NOT ANDROID)
      set(INCLUDE_INSTALL_ROOT
          "include/${PROJECT_NAME_LOWER}-${RTF_VERSION_MAJOR}.${RTF_VERSION_MINOR}")
    else()
      set(INCLUDE_INSTALL_ROOT "include") # Android, don't put into subdir
    endif()
    set(INCLUDE_INSTALL_DIR "${INCLUDE_INSTALL_ROOT}/rtf")
    set(DOC_INSTALL_DIR "share/doc/${PROJECT_NAME_LOWER}-${RTF_VERSION_MAJOR}.${RTF_VERSION_MINOR}")
    set(BIN_INSTALL_DIR "bin")
    set(PKGCFG_INSTALL_DIR "${LIB_INSTALL_DIR}/pkgconfig")
    if(WIN32 AND NOT MINGW)
        set(RTFCONFIG_INSTALL_DIR "cmake")
      else()
        set(RTFCONFIG_INSTALL_DIR "share/${PROJECT_NAME_LOWER}-${RTF_VERSION_MAJOR}.${RTF_VERSION_MINOR}")
      endif()
endmacro()
